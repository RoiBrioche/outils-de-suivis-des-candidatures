...
class PeriodeRechercheAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Informations générales", {"fields": ("nom", "description", "active")}),
...
class ContactAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Informations générales", {"fields": ("nom", "prenom", "poste_occupe")}),
        ("Coordonnées", {"fields": ("email", "telephone", "linkedin_url")}),
        ("Informations supplémentaires", {"fields": ("commentaires",)}),
        (
            "Métadonnées",
            {"fields": ("id", "created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class PisteCandidatureAdmin(admin.ModelAdmin):
    ...
    filter_horizontal = (
        "contacts",
    )  # Crée une interface à deux colonnes (Dispo / Choisi)
...
class CandidatureAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Détails du poste", {"fields": ("localisation", "contrat", "canal")}),
        ("Dates", {"fields": ("date_candidature", "date_statut")}),
        ("Priorité", {"fields": ("priorite", "priorite_source", "date_priorite")}),
        (
...
class DocumentCandidatureAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Stockage", {"fields": ("chemin_fichier", "mime_type", "taille")}),
        ("Informations supplémentaires", {"fields": ("commentaire",)}),
        ("Métadonnées", {"fields": ("id", "date_ajout"), "classes": ("collapse",)}),
    )
